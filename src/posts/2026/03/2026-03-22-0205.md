...
jobs:
  deploy:
    ...
    steps:
      ...
      # 1. 物理ディレクトリの存在保証とCSS生成（404.mdは排除）
      ...
      # 2. カスタムテンプレートを生成（<base>タグによる絶対パス強制）
        ...
        run: |
          ...
          plugins:
            - blog:
                ...
                post_url_format: "{date}/{file}.html"
