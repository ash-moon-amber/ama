...
jobs:
  deploy:
    ...
    steps:
      ...
      # 2. OGP用のカスタムテンプレートを生成（404.mdがあるためシンプルな構文で記述可能）
      - name: Create overrides for OGP
        run: |
          ...
          {% block extrahead %}
            ...
            <meta property="og:title" content="{{ page.title | d(config.site_name, true) }}" />
            <meta property="og:description" content="{{ page.meta.description | d(config.site_description, true) }}" />
            <meta property="og:url" content="{{ page.canonical_url | d(config.site_url, true) }}" />
            <meta property="og:image" content="{{ config.site_url }}assets/og-image.png" />
            <meta property="og:image:width" content="1200" />
            <meta property="og:image:height" content="630" />
            <meta name="twitter:card" content="summary_large_image" />
            <meta name="twitter:title" content="{{ page.title | d(config.site_name, true) }}" />
